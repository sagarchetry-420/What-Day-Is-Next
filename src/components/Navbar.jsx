    ...
    <header className="w-full bg-transparent">
      <div className="flex w-full items-center justify-between px-4 py-4 sm:px-6 sm:py-5 lg:px-10">
        <div className="flex items-center gap-3">
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl text-accent-orange">
          ...
          <span className="font-brand text-base text-accent-orange sm:text-lg">WhatDayIsNext</span>
        </div>
